...
```
    ...
    ## file path:          /Users/lisi/Library/Caches/rnoaa/ghcnd/USW00094728.dly

    ## file last updated:  2019-09-26 10:25:17
...
```
    ...
    ## Please use `cols = c(reslt_g, reslt_t)`
...
![](p8105_hw6_sl4657_files/figure-gfm/unnamed-chunk-6-1.png)<!-- -->
...
![](p8105_hw6_sl4657_files/figure-gfm/unnamed-chunk-6-2.png)<!-- -->

Distribution of r\_squared is nearly normally distributed, but a bit
right skewed, might because of some outliers in the sample.
